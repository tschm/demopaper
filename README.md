...
For local development, you can run the `make_header.sh` script manually to generate a `header.tex` file with your current Git metadata:
...
Alternatively, you can create your own custom `header.tex` file in the paper directory that defines the required LaTeX commands:
...
if you don't run the `make_header.sh` script, you should ensure that the placeholder file defines all the commands used in the document:
