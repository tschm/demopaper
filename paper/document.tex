...
%\usepackage{verbatim}    % To parse header.txt
...
%\newread\headerfile
%\openin\headerfile=header.txt
%\read\headerfile to \headervalue
%\closein\headerfile
...
\fancyhead[L]{%
  \parbox[t]{0.8\textwidth}{%
    \raggedright\ttfamily\small\textcolor{blue}{\input{header.tex}}%
  }%
}
...
\fancyhead[R]{%
  \parbox[t]{0.2\textwidth}{%
    \raggedleft\ttfamily\small\textcolor{blue}{\today}%
  }%
}
