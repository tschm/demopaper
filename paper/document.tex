...
\usepackage{catchfile}    % For reading environment variables
%\usepackage{amsmath}
...
% Define a command for the repository tag from environment variable
\newcommand{\repotag}{%
  \CatchFileEdef{\repotagval}{|kpsewhich --var-value=REPO_TAG}{}%
  \ifx\repotagval\empty\else\repotagval\fi%
}

% Setup fancy headers
\pagestyle{fancy}
\fancyhf{} % Clear all header and footer fields
\fancyhead[R]{\textcolor{myblue}{\repotag}} % Add tag to the right header in blue
